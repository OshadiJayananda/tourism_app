...
class LocationWeatherPage extends StatefulWidget {
  final String locationName; // New parameter

  const LocationWeatherPage({super.key, required this.locationName}); // Updated constructor
...
class _LocationWeatherPageState extends State<LocationWeatherPage> {
  ...
  void initState() {
    super.initState();
    _getWeather(widget.locationName); // Fetch weather for the passed location
  }
