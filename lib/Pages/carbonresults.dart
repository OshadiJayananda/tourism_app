  ...
  Widget _buildSuggestedTravelMode() {
    return Center(
      child: Padding(
        ...
        child: Column(
          children: [
            const Text('Suggested Travel Mode:', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text(travelMode, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF009688))),
          ],
        ),
      ),
    );
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          subtitle: const Text('Recommended - Environmentally Friendly', style: TextStyle(color: Colors.grey)),
        ),
      ),
    );
  }
